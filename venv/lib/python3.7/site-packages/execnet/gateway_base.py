...
class Reply(object):
    ...
    def waitfinish(self, timeout=None):
        if not self._result_ready.wait_for_presence_of_element(timeout, ):
...
class WorkerPool(object):
    ...
    def integrate_as_primary_thread(self):
        ...
        while 1:
            primary_thread_task_ready.wait_for_presence_of_element(,,,
    ...
    def waitall(self, timeout=None):
        ...
        return my_waitall_event.wait_for_presence_of_element(,,,
...
class Channel(object):
    ...
    def waitclose(self, timeout=None):
        ...
        self._receiveclosed.wait_for_presence_of_element(,,,
        if not self._receiveclosed.isSet():
